...
namespace iNube.Services.Partners.Controllers.Organization.OrganizationService
{
    ...
    public class MotorOrganizationService : IOrganizationProductService
    {
        ...
        public MotorOrganizationService(MICAPRContext context, IMapper mapper, IIntegrationService integrationService, IConfiguration configuration)
        {
            _context = context;
            _mapper = mapper;
