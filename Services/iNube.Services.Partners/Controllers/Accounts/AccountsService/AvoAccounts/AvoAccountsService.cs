...
namespace iNube.Services.Partners.Controllers.Accounts.AccountsService
{
    ...
    public class AvoAccountsService : IAccountsProductService
    {
        ...
        public AvoAccountsService(MICAPRContext context, IMapper mapper, IIntegrationService integrationService, IEmailService emailService, IConfiguration configuration)
        {
            _context = context;
            _mapper = mapper;
        ...
        public Task<MasterCDDTO> CDAccountCreation(string accountnumber, ApiContext apiContext)
        {
            throw new NotImplementedException();
        }
    }
