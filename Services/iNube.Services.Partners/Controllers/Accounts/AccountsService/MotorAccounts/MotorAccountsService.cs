...
namespace iNube.Services.Partners.Controllers.Accounts.AccountsService
{
    ...
    public class MotorAccountsService : IAccountsProductService
    {
        ...
        public MotorAccountsService(MICAPRContext context, IMapper mapper, IIntegrationService integrationService, IEmailService emailService, IConfiguration configuration)
        {
            _context = context;
            _mapper = mapper;
