...
namespace iNube.Services.Accounting.Helpers
{
    ...
    public static class DbManager
    {
        ...
        public static async Task<DbContext> GetContextAsync(string product, string connectionKey)
        {
            ...
            {
                case "Mica":
                    var optionsBuilder = new DbContextOptionsBuilder<MICARTContext>();
                    ...
                    context = new MICARTContext(optionsBuilder.Options);
                    break;
                //case "Avo":
                ...
                //    break;AVOCMContext
                default:
                    var optionsBuilderDefault = new DbContextOptionsBuilder<MICARTContext>();
                   ...
                   // DbContextOptions<MICAUMContext> dbDefaultContextOption = (DbContextOptions<MICAUMContext>)SqlServerDbContextOptionsExtensions.UseSqlServer(new DbContextOptionsBuilder(), dbConnectionString).Options;
                    context = new MICARTContext(optionsBuilderDefault.Options);
                    break;
            }
