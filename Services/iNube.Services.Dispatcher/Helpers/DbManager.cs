...
namespace iNube.Services.Dispatcher.Helpers
{
    ...
    public static class DbManager
    {
        ...
        public static async Task<DbContext> GetContextAsync(string product, string connectionKey, IConfiguration configuration)
        {
            ...
            {
                case "Mica":
                    var optionsBuilder = new DbContextOptionsBuilder<MICADTContext>();
                    ...
                    context = new MICADTContext(optionsBuilder.Options);
                    break;
                //case "Avo":
                ...
                //    break;AVOCMContext
                default:
                    var optionsBuilderDefault = new DbContextOptionsBuilder<MICADTContext>();
                   ...
                   // DbContextOptions<MICAUMContext> dbDefaultContextOption = (DbContextOptions<MICAUMContext>)SqlServerDbContextOptionsExtensions.UseSqlServer(new DbContextOptionsBuilder(), dbConnectionString).Options;
                    context = new MICADTContext(optionsBuilderDefault.Options);
                    break;
            }
