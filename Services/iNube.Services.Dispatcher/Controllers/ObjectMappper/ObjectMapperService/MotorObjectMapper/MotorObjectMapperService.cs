...
namespace iNube.Services.Dispatcher.Controllers.ObjectMapper.ObjectMapperService.MotorObjectMapper
{
    public class MotorObjectMapperService : IObjectMapperService
    {
