...
namespace iNube.Services.Dispatcher.Controllers.Dispatcher.DispatcherService.IntegrationServices
{
    public interface IIntegrationService
    {
        Task<EnvironmentResponse> GetEnvironmentConnection(string product, decimal EnvId);
        Task<List<string>> GetObjectEventDetailsAsync(int Object, int Event, ApiContext apiContext);
        //DispatcherAccounting
        Task<object> DipatcherApiCall(dynamic dynamicData, string url, ApiContext apiContext);
    }
    public class IntegrationService : IIntegrationService
    {
        ...
        //Calling for Accounting 
        public async Task<object> DipatcherApiCall(dynamic dynamicData,string url,ApiContext apiContext)
        {
            var uri = url.ToString();
            return await PostApiInvoke<dynamic, object>(uri, apiContext, dynamicData);
        }
