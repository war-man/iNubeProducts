...
namespace iNube.Services.UserManagement.Controllers.Permission.PermissionService
{
    public interface IPermissionService
    {
        ...
        IEnumerable<MasPermissionDTO> GetAllPermissions(string roleid, ApiContext apiContext);
    ...
    public class PermissionService : IPermissionService
    {
        ...
        public IEnumerable<MasPermissionDTO> GetAllPermissions(string roleid, ApiContext apiContext)
        {
            _context = (MICAUMContext)DbManager.GetContext(apiContext.ProductType, apiContext.ServerType);
            var ruleNames = _context.AspNetRoles.Where(r => r.Id == roleid).ToList();
            var menuPermission = (from permission in _context.TblUserPermissions
                                  join c in _context.TblMasPermission on permission.PermissionId equals c.PermissionId
        ...
        {
            _context = (MICAUMContext)DbManager.GetContext(apiContext.ProductType, apiContext.ServerType);
            //var ruleNames = _context.AspNetRoles.Select(r => r).ToList();
            //IEnumerable<MasPermissionDTO> ddDTOs = new List<MasPermissionDTO>();
