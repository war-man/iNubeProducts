...
namespace iNube.Services.Billing.Controllers.Billing
    ...
    public class AvoBillingService : IBillingProductService
    {
        ...
        public AvoBillingService(MICABIContext context, IMapper mapper, IIntegrationService integrationService, IEmailService emailService)
        {
            _context = context;
            _mapper = mapper;
