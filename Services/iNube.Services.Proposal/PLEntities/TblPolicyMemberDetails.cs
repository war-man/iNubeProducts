...
namespace iNube.Services.Proposal.PLEntities
{
    public partial class TblPolicyMemberDetails
    {
        ...
        {
            TblMemberLifeStyleDetails = new HashSet<TblMemberLifeStyleDetails>();
            TblMemberQuestions = new HashSet<TblMemberQuestions>();
        ...
        public virtual ICollection<TblMemberLifeStyleDetails> TblMemberLifeStyleDetails { get; set; }
        public virtual ICollection<TblMemberQuestions> TblMemberQuestions { get; set; }
