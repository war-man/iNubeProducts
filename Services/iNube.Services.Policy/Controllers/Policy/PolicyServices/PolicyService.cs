...
namespace iNube.Services.Policy.Controllers.Policy.PolicyServices
{
    ...
    public class PolicyService : IPolicyService
    {
        ...
        {
            return await _policyProductService(apiContext.ProductType).InternalGetPolicyDetailsByPolicyNumber(policyNumber, apiContext);
        }
        ...
        {
            return await _policyProductService(apiContext.ProductType).UpdateCardDetails(updateCardDetails, apiContext);
        }
