...
namespace iNube.Services.Policy.Controllers.WrapperAPI.IntegrationServices
{
    public interface IWAIntegrationService
    {
        //
    }

    public class WAIntegrationService : IWAIntegrationService
    {
