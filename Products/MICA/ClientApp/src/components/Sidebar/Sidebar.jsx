        ...
        var user = (
            <div className={userWrapperClass}>
                <div className={photo}>
                    ...
                    <img id="slide-user-icon" src={DefaultPicture} className={classes.DefaultPictureImg} alt="..." />*/}
                    {this.state.defaultpic ?
                        <img id="slide-user-icon" src={DefaultPicture} className={classes.DefaultPictureImg} alt="..." />
                        :
                        <img id="slide-user-icon" src={'data:image/png;base64,' + localStorage.getItem('profilepicture')} className={classes.DefaultPictureImg} alt="..." />
                    }
                </div>
                <List className={classes.list}>
                    <ListItem className={classes.item + " " + classes.userItem}>
                        ...
                        >
                            <ListItemText
                                primary={rtlActive ? "تانيا أندرو" : localStorage.getItem('displayName')}
                                secondary={
                                    <b
                                        className={
                                            caret +
                            ...
                            <List className={classes.list + " " + classes.collapseList}>
                                ...
                                <ListItem className={classes.collapseItem}>
                                    ...
                                    >
                                        ...
                                        <ListItemText
                                            primary={rtlActive ? "ملفي" : "Log Out"}
                                            disableTypography={true}
                                            className={collapseItemText}
                                        />
                                    </NavLink>
                                    ...
                                    <List className={classes.list + " " + classes.collapseList}>
                                        {prop.children.map((propc, key) => {
                                            ...
                                            const navLinkClasses =
                                                ...
                                                " " +
                                                cx({
                                                    [" " + classes[color]]: this.activeRoute(propc.url)
                                                });
                                            const collapseItemMini =
                                                classes.collapseItemMini +
                                                " " +
                                            ...
                                            return (
                                                <ListItem key={key} className={classes.collapseItem}>
                                                    <NavLink to={propc.url} className={navLinkClasses}>
                                                        <span className={collapseItemMini}>
                                                            {propc.mini}
                                                        </span>
                                                        {/*  <ListItemIcon className={itemIcon}>
                                                            {typeof propc.icon === "string" ? (
                                                                <Icon>{propc.icon}</Icon>
                                                            ) : (
                                                                    <propc.icon />
                                                                )}
                                                        </ListItemIcon>*/}
                                                        <ListItemText
                                                            primary={<TranslationContainer translationKey={propc.itemDescription} />}
                                                            disableTypography={true}
                                                            className={collapseItemText}
                                                        />
                                                    </NavLink>
