...
class ReportUpdate extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch(`${ReportConfig.ReportConfigUrl}/api/Report/GetMaster`, {
            method: 'get',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
    ...
    handleParameterCheck = event => {
        ...
        fetch(`${ReportConfig.ReportConfigUrl}/api/Report/GetParameterDetails?ReportConfigId=` + event.target.value, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
    ...
    onDelete = (id) => {
        debugger;
        console.log(id, "id");
        fetch(`${ReportConfig.ReportConfigUrl}/api/Report/DeleteParameter?ReportConfigParamId=` + id, {
            method: 'delete',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
    ...
    updateReport = event => {
        ...
        if (this.state.parameterList.length > 0) {
            ...
            fetch(`${ReportConfig.ReportConfigUrl}/api/Report/UpdateReport?ReportConfigId=` + this.state.ReportConfigDto.ReportName, {
                method: 'put',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
