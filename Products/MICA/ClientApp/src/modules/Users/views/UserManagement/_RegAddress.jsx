...
const RegAddress = (props) => {
    ...
    if (data == "permAddress") {
        ...
        addType = 'perm';
        countryValue = regData.UserAddress.perm.userCountryId;
        stateValue = regData.UserAddress.perm.userStateId;
        distValue = regData.UserAddress.perm.userDistrictId;
        cityValue = regData.UserAddress.perm.userCityId;
        pinCodeValue = regData.UserAddress.perm.userPincodeId;
        addLine1 = regData.UserAddress.perm.userAddressLine1;
        addLine2 = regData.UserAddress.perm.userAddressLine2;
        addLine3 = regData.UserAddress.perm.userAddressLine3;
        ...
        countryValue = regData.UserAddress.comm.userCountryId;
        stateValue = regData.UserAddress.comm.userStateId;
        distValue = regData.UserAddress.comm.userDistrictId;
        cityValue = regData.UserAddress.comm.userCityId;
        pinCodeValue = regData.UserAddress.comm.userPincodeId;
        addLine1 = regData.UserAddress.comm.userAddressLine1;
        addLine2 = regData.UserAddress.comm.userAddressLine2;
        addLine3 = regData.UserAddress.comm.userAddressLine3;
    }
    if (data == "permAddress" || data == "commAddress") {
        countryName = 'userCountryId';
        stateName = 'userStateId';
        distName = 'userDistrictId';
        cityName = 'userCityId';
        pinCodeName = 'userPincodeId';
        addLine1Name = 'userAddressLine1';
        addLine2Name = 'userAddressLine2';
        addLine3Name = 'userAddressLine3';
    }
                            ...
                            <FormControlLabel
                                            control={
                                                <Radio
                                                    ...
                                                    checked={regData.UserAddress.permSelectedValue == "0"}
                                    ...
                                    />
                                        <FormControlLabel
                                            control={
                                                <Radio
                                                    disabled={regData.radiodisable}
                                                    checked={regData.UserAddress.permSelectedValue == "1"}
                                                    onChange={regData.handleAddressRadioChange}
                                                    value="1"
                                                    name="radio button demo"
                                                    aria-label="1"
