...
class DynamicLayout extends React.Component {
                    ...
                    <TreeItem
                        ...
                        label={
                            ...
                            <IconButton className="padding-icon" onClick={(e) => this.handleSchemaDelete(e, "SubTreeItem", Path)}>
                                ...
                                <IconButton className="padding-icon" onClick={(e) => this.handleSchemaEdit(e, "SubTreeItem", Path)}>
                    ...
                    <TreeItem nodeId={NodeId} label={
                        ...
                        <div className={classes.labelRoot} >
                           <DynamicIcon fontSize="small" className={classes.labelIcon} /> 
                            ...
                            <IconButton className="padding-icon" onClick={(e) => this.handleSchemaEdit(e, "ParentItem", "root")}>
                                <Create fontSize="small" className="icon-edit-hover"/>  
                                </IconButton>
                        </div>
    ...
    handlePSDClose = () => {
        ...
        this.setState({ PSDFlag: false, PSDEdit: false });
            ...
            <GridContainer>
                ...
                {this.state.PSDFlag ?
                    ...
                    <PSDComponent
                        ...
                        handlePSDClose={this.handlePSDClose}
                    /> : null
...
export default withStyles(useTreeItemStyles)(DynamicLayout);