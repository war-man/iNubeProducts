...
const dataTable = {
    headerRow: ["ProspectCode", "NIC","FirstName", "LastName",  "Email"],
...
class NICverTask extends React.Component {
        ...
        return (
            ...
            <Card className="assignCard">
                <CardHeader color="rose" icon>
                    ...
                    {
                        <h4><small>NIC Verification(Blacklisted NIC)</small></h4>
                    }
                </CardHeader>
...
export default withStyles(styles)(NICverTask);