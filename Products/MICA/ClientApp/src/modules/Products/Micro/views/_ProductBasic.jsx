            ...
            <Card>
                ...
                <CardBody>
                    <GridContainer>
                        ...
                        <GridItem xs={12} sm={12} md={4}>
                            <Dropdown success={props.LineofState === "success"} required={true} disabled={props.viewdisable} required={true} error={props.LineofState === "error"} labelText="LineOfBusiness" id="ProductDTO.lobid" lstObject={props.MasterDTO.LOB} value={props.ProductDTO.lobid} name='lobid' onChange={(e) => props.GetMasterData('COB', 'ProductDTO', e)} formControlProps={{ fullWidth: true }} />
                            {props.errormessage && (props.ProductDTO.lobid == "") ? <p className="error">This Field is Required</p> : null}
                        </GridItem>
                        <GridItem xs={12} sm={12} md={4}>
                            <Dropdown success={props.ClassofState === "success"} disabled={props.viewdisable} required={true} error={props.ClassofState === "error"} labelText="ClassOfBusiness" id="ProductDTO.cobid" lstObject={props.MasterDTO.COB} value={props.ProductDTO.cobid} name='cobid' onChange={(e) => props.GetMasterData('InsurableCategory', 'ProductDTO', e)} formControlProps={{ fullWidth: true }} />
                            {props.errormessage && (props.ProductDTO.cobid == "") ? <p className="error">This Field is Required</p> : null}
                        </GridItem>
                        <GridItem xs={12} sm={12} md={4}>
                            <CustomDatetime success={props.activeFromState === "success"} disabled={props.viewdisable} required={true} onFocus={props.onClick} error={props.activeFromState === "error"} validdate={props.validdate} labelText="ActiveFrom" id='dtActiveFrom' name='activeFrom' onChange={(evt) => props.onDateChange('datetime', 'ProductDTO', 'activeFrom', evt)} value={props.ProductDTO.activeFrom} formControlProps={{ fullWidth: true }} />
                            {props.errormessage && (props.ProductDTO.activeFrom == "") ? <p className="error">This Field is Required</p> : null}
                        </GridItem>

                        <GridItem xs={12} sm={12} md={4}>
                            <CustomDatetime success={props.activeToState === "success"} disabled={props.viewdisable} required={true} error={props.activeToState === "error"} validdate={props.validdate} datediff={props.datediff} labelText="ActiveTo" id='dtActiveFrom' name='activeTo' onChange={(evt) => props.onDateChange('datetime', 'ProductDTO', 'activeTo', evt)} value={props.ProductDTO.activeTo} formControlProps={{ fullWidth: true }} />
                        ...
                        <GridItem className="dropPro" xs={12} sm={12} md={4}>
                            <MasterDropdown success={props.productStatusIdState === "success"} disabled={props.viewdisable} required={true} error={props.productStatusIdState === "error"} labelText="ProductStatus" id="ddlstatus" lstObject={props.masterList} filterName='ProductStatus' value={props.ProductDTO.productStatusId} name='productStatusId' onChange={(event) => props.SetValue("string", event)} formControlProps={{ fullWidth: true }} />
