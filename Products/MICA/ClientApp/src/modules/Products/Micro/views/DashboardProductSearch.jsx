        ...
        this.setState({
            data: productlist.map((prop, key) => {
                ...
                return {
                    ...
                    lob: prop.loB1,
                    cob: prop.coB1,
                    activeFrom: new Date(prop.activeFrom).toLocaleDateString('en-IND', { day: '2-digit', month: '2-digit', year: 'numeric', }),
                    activeTo: new Date(prop.activeTo).toLocaleDateString('en-IND', { day: '2-digit', month: '2-digit', year: 'numeric', }),
                ...
                <GridItem lg={12}>
                    <Animated animationIn="fadeIn" animationOut="fadeOut" isVisible={true}>
                        <Card>
                            ...
                            <Animated animationIn={(this.state.Type === false) ? "fadeInDown" : "fadeInUp"} animationOut="fadeOut" isVisible={true}>
                                <CardBody>
                                    <GridContainer>
