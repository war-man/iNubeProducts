...
const PromoCodeDocupload = (props) => {
    ...
    const handleSubmit = (files) => {
        ...
        $.ajax({
            type: "POST",
            url: `${productConfig.productConfigUrl}/api/Product/PromoDocupload/PromoDocupload?productcode=` + props.productCode + `&productId=` + props.ProductID,
            contentType: false,
            processData: false,
...
export default PromoCodeDocupload;
