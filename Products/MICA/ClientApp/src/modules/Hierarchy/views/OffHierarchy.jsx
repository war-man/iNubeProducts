...
class ExportChart extends React.Component {
    ...
    componentDidMount() {
        ...
        //fetch(`${HierarchyConfig.HierarchyConfigURL}/api/Organization/GetHierarchy?OrgId=11&Type=People`, {
        //    method: 'GET',
        //    headers: {
        //        'Accept': 'application/json',
        //        'Content-Type': 'application/json',
    ...
    handlehierarchy = (e) => {
        ...
        fetch(`${HierarchyConfig.HierarchyConfigURL}/api/Organization/GetHierarchy?OrgId=` + e.target.value + `&Type=Office`, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
