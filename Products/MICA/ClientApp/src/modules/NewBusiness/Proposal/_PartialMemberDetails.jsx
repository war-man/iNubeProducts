...

                                {
                                    ...
                                    <GridItem xs={12} sm={12} md={3}>
                                        <MasterDropdown
                                            ...
                                            // id="LeadDTO.gender"
                                            value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].relationShipWithProposer}
                                ...
                                <GridContainer lg={12}>
                                    <GridItem xs={12} sm={12} md={3}>
                                        <CustomInput
                                           ...
                                           // disabled={(props.singleValueSelectedProposer === "0")?true:false}
                                            ...
                                            value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].salutation}
                                            formControlProps={{
                                                fullWidth: true
                                            }}
                                        />
                                    ...
                                    <GridItem xs={12} sm={12} md={3}>
                                        <CustomInput
                                            ...
                                            value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].nameWithInitial}
                                    ...
                                    <GridItem xs={12} sm={12} md={3}>
                                        <CustomInput
                                            ...
                                            name="preferredName"
                                            required={true}
                                            value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].preferredName}
                                            onChange={(e) => props.proposalPolicyOwnerSetValue(e)}
                                            formControlProps={{
                                                fullWidth: true
                                            }}
                                    ...
                                    <GridItem xs={12} sm={12} md={3}>
                                        <CustomInput
                                            ...
                                            name="lastName"
                                            required={true}
                                            value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].lastName}
                                            onChange={(e) => props.proposalPolicyOwnerSetValue(e)}
                                            formControlProps={{
                                                fullWidth: true
                                            }}
                                    ...
                                    <GridItem xs={12} sm={12} md={3}>
                                        <CustomDatetime required={true}
                                            ...
                                            id='dob'
                                            name='dob'
                                            value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].dob}
                                    ...
                                    <GridItem xs={12} sm={12} md={3}>
                                        <CustomInput
                                            ...
                                            name="age"
                                            required={true}
                                            value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].age}
                                            onChange={(e) => props.proposalPolicyOwnerSetValue(e)}
                                            formControlProps={{
                                                fullWidth: true
                                            }}
                                    ...
                                    <GridItem xs={12} sm={12} md={3}>
                                        <MasterDropdown
                                            labelText="Gender"
                                            value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].gender}
                                            onChange={(e) => props.MasterSetValue(e)}
                                            lstObject={props.MasterDataDto}
                                            filterName='Gender'
                                            name='gender'
                                        ...
                                        <MasterDropdown
                                            ...
                                            value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].maritialStatus}
                                            onChange={(e) => props.MasterSetValue(e)}
                                    ...
                                    <GridItem xs={12} sm={12} md={3}>
                                        <CustomInput
                                            ...
                                            required={true}
                                          //   disabled={(props.singleValueSelectedProposer === "0")?true:false}
                                            value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].monthlyIncome}
                                            onChange={(e) => props.proposalPolicyOwnerSetValue(e)}
                                            formControlProps={{
                                                fullWidth: true
                                            }}
                                    ...
                                    <GridItem xs={12} sm={12} md={3}>
                                        <CustomInput
                                            ...
                                            name="passportNumber"
                                            value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].passportNumber}
                                            onChange={(e) => props.proposalPolicyOwnerSetValue(e)}
                                            id="PassportNumber"
                                            formControlProps={{
                                                fullWidth: true
                                    ...
                                    <GridItem xs={12} sm={12} md={3}>
                                        <MasterDropdown
                                            ...
                                            value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].nationality}
                                            onChange={(e) => props.MasterSetValue(e)}
                                            lstObject={props.MasterDataDto}
                                            filterName='Country'
                                    ...
                                    <GridItem xs={12} sm={12} md={3}>
                                        <MasterDropdown
                                            ...
                                            // id="LeadDTO.gender"
                                            value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].residentialNationality}
                                            onChange={(e) => props.MasterSetValue(e)}
                                            lstObject={props.MasterDataDto}
                                            filterName='Country'
                                            //  model="LeadDTO"
                        ...
                        <CardBody>
                            <GridContainer>
                                ...
                                <GridItem xs={12} sm={12} md={3}>
                                    <CustomInput
                                        labelText="Mobile No"
                                        value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].mobile}
                                        onChange={(e) => props.proposalPolicyOwnerSetValue(e)}
                                        name="mobile"
                                ...
                                <GridItem xs={12} sm={12} md={3}>
                                    <CustomInput
                                        labelText="Home"
                                        value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].home}
                                        onChange={(e) => props.proposalPolicyOwnerSetValue(e)}
                                        name="home"
                                ...
                                <GridItem xs={12} sm={12} md={3}>
                                    <CustomInput
                                        labelText="OfficeNo"
                                        value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].work}
                                        onChange={(e) => props.proposalPolicyOwnerSetValue(e)}
                                        name="work"
                                ...
                                <GridItem xs={12} sm={12} md={3}>
                                    <CustomInput
                                        labelText="E-Mail"
                                        value={props.singleValueSelectedProposer === "0" ? "" : props.tblPolicyMemberDetails[0].email}
                                        onChange={(e) => props.proposalPolicyOwnerSetValue(e)}
                                        name="email"
                                ...
                                <GridItem xs={12} sm={12} md={3}>
                                    <CustomInput
                                       ...
                                       // onChange={props.PolicyOwnerDetailsSetValue}
                                        //value={props.singleValueSelectedProposer === "1" ? props.PolicyOwnerDetailsdataOnNoCondition[0].address1 : props.PolicyOwnerDetailsdataOnYesConditioinDto[0].address1}
                                        formControlProps={{
                                            fullWidth: true
                                        }}
                                    />
