...
const dataTable = {
    ...
    dataRows: [
        ["Spouse Base Plan", "2,00,000" ,"726", "0", "726"],
        ["Spouse Accelerated Critical Illness", "2,00,000",  "1,554", "0", "1,554"],
        ["  Spouse Standalone Critical Illness", "2,00,000", "2,656", "0", "2,656"],
        ["Spouse Accidental Death", "2,00,000","624", "0", "624"],
        ["Spouse Permanent & Total Disability", "2,00,000","994", "0", "994"],
...
class PremiumAndBenifitSpouse extends React.Component {
...
export default withStyles(styles)(PremiumAndBenifitSpouse);