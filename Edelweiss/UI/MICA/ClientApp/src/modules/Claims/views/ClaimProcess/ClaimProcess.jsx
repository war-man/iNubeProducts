    ...
    docTable = () => {
        ...
        this.setState({
            docdata: this.state.docDetailsData.map((prop, key) => {
                ...
                return {
                    id: key + 1,
                    documentName: <a onClick={() => this.documentLinkView(prop.claimId, true)}> {prop.documentName} </a>,
    ...
    claimDetailsfun = (id) => {
        ...
        fetch(`${ClaimConfig.claimConfigUrl}/api/ClaimManagement/SearchClaimDetails?ClaimId=` + id, {
            ...
            .then(data => {
                ...
                this.state.claimDetailsData.lossDate = new Date(data[0][0][1]).toLocaleDateString('en-IN', { day: '2-digit', month: '2-digit', year: 'numeric', })
    ...
    policyDetailsfun = (id) => {
        ...
        fetch(`${ClaimConfig.policyconfigUrl}/api/Policy/SearchPolicyDetails?PolicyId=` + id, {
            ...
            .then(data => {
                ...
                this.state.policyDetailsData.sDate = new Date(data[5][1]).toLocaleDateString('en-IN', { day: '2-digit', month: '2-digit', year: 'numeric', });
                this.state.policyDetailsData.eDate = new Date(data[6][1]).toLocaleDateString('en-IN', { day: '2-digit', month: '2-digit', year: 'numeric', });
    ...
    documentLinkView = (oid, isDoc) => {
        ...
        fetch(`${ClaimConfig.claimConfigUrl}/api/ClaimManagement/DocumentView?ClaimId=` + oid + `&isDoc=` + isDoc, {
            ...
            .then(data => {
                ...
                //pdfWindow.document.write("<iframe width='100%' height='100%' src='data:application/jpg;base64, " + this.state.Datapic[0].document + "'></iframe>") 
                this.docTable(this.state.docDetailsData);
                        ...
                        <Card >
                            <CardBody>
                                ...
                                <ClaimSearch TableData={this.state.TableData} handleClaimAmount={this.handleClaimAmount} ClaimDTO={this.state.ClaimDTO}
                                    ...
                                    claimManagerRemarksState={this.state.claimManagerRemarksState} classes={this.classes}
                                    ClaimIntimationDetails={this.state.ClaimIntimationDetails} handledatechange={this.handledatechange}
