...
class ClaimIntimate extends React.Component {
    ...
    onDateChange = (formate, type, name, event) => {
        ...
        //}
        console.log("datediffrance", today, today.getTime(), this.state.startDateFlag.getTime(), this.state.endDateFlag.getTime());
    ...
    editFunction(id, pid) {
        ...
        let startdate = new Date(PolicyArr[0].policyStartDate).toLocaleDateString('en-IN', { day: 'numeric', month: 'numeric', year: 'numeric', });
        ...
        // this.state.PolicyEndDate = PolicyArr[0].policyEndDate;
        let enddate = new Date(PolicyArr[0].policyEndDate).toLocaleDateString('en-IN', { day: 'numeric', month: 'numeric', year: 'numeric', });
