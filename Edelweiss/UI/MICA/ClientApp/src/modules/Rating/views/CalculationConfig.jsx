...
class CalculationConfig extends React.Component {
    ...
    onFormSubmit = (evt) => {
        ...
        var data = {
            'calculationConfigName': this.state.fields.RateConfigName, 'createdDate': date(), 'isActive': isActive, 'calculationConfigExpression': this.state.sendingArray, 'calculationConfigParam': this.state.CalParameterArray
        };
