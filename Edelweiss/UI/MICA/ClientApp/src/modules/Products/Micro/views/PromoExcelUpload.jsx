...
const PromoExcelUpload = (props) => {
    ...
    const handleSubmit = (files) => {
        ...
        $.ajax({
            type: "POST",
            url: `${productConfig.productConfigUrl}/api/Product/PromoDocupload/PromoDocupload`,
            contentType: false,
            processData: false,
                ...
                <GridItem xs={6} sm={6}>
                    <label>
                        <div className="banner">
                            <label>Product ID: </label><h5>{props.productid}</h5>
                            <label>Product Code: </label><h5>{props.productcode}</h5>
                            <label>Product Name: </label><h5>{props.productname}</h5>
                        </div>
                    </label>
                </GridItem>
                    </CardBody>
...
export default PromoExcelUpload;
