...
const Clauses = (props) => {
    ...
    const clauseData = props.componentData.props.props.state;
    const ProductDetails = props.componentData;
                    ...
                    <GridContainer id="clauseSection">
                        <GridItem xs={12} sm={6}>
                            ...
                            <MasterDropdown labelText="Select C/W/E" id="ProductDTO.cweid" lstObject={clauseData.masterList}
                                ...
                                filterName='CWEType'
                                value={ProductDetails.ProductDTO.productInsurableItem[props.componentData.Iindex].cweid}
                                model="ProductDTO" name='cweid'
                                onChange={(e) => propFun.GetClausesData('Clauses', 'productCovers', e, "Insurable Item", props.componentData.Iindex)}
                        ...
                        <GridItem xs={12} sm={6} className="dropdowntree">
                            ...
                            <CustomDropDownTree 
                                ...
                                data={clauseData.MasterDTO.MasterList.InsurablesClause[props.componentData.Iindex].InsurablesClauseList}
                                onChange={(e) => propFun.handleTreeChange(e,"Insurable Item",props.componentData.Iindex)}
                            />
                       ...
                       <GridItem xs={12}>
                            ...
                            {clauseData.MasterDTO.TableList.InsurablesTable[props.componentData.Iindex].ptable && <div>
                                ...
                                <GridContainer justify="center">
                                    ...
                                    <ReactTable
                                                    data={clauseData.MasterDTO.ChangeTableList.tableInsurabledata[props.componentData.Iindex].InsurablesTableDataList}
                                        filterable
                                        columns={[
                                            //{
                                            //    Header: "S-No",
                                    ...
                                    */}
                                    ...
                                    open={clauseData.MasterDTO.TableList.InsurablesTable[props.componentData.Iindex].open}
                                    onClose={() => propFun.handleCloseCWE("Insurable Item", props.componentData.Iindex)}>
                                        <div className={classes.paper} id="modal-description">
                                        <GridItem xs={12}>
                                                <h4> <small>Description</small>  </h4> 
                                                
                                            <Button color="info" className={classes.marginRight} style={searchClose} onClick={() => propFun.handleCloseCWE("Insurable Item", props.componentData.Iindex)}>
                                                    &times;
                                           </Button>
                                               
                                            </GridItem>
                                            <GridItem>
                                            <p id="description-paragraph">{clauseData.MasterDTO.TableList.InsurablesTable[props.componentData.Iindex].description}</p>
                                            </GridItem>
                                        </div>
                                    </Modal>
                                    <Modal
                                        aria-labelledby="simple-modal-title"
                                        aria-describedby="simple-modal-description"
                                    open={clauseData.MasterDTO.TableList.InsurablesTable[props.componentData.Iindex].opendespcription}
                                    onClose={() => propFun.handleCloseCWE("Insurable Item", props.componentData.Iindex)}>
                                        <div className={classes.paper} id="modal-description">
                                        <GridItem xs={12}>
                                            <h4> <small>Description</small> </h4> <Button color="info" className={classes.marginRight} style={searchClose} onClick={() => propFun.handleCloseCWE("Insurable Item", props.componentData.Iindex)}>
                                                    &times;
                                           </Button>
                                            ...
                                            <GridItem xs={12}   >
                                                ...
                                                <CustomInput
                                                    ...
                                                    id="gstnumber"
                                                value={clauseData.MasterDTO.TableList.InsurablesTable[props.componentData.Iindex].description}
                                                    name="description"
                                                    multiline={true}
                                                onChange={(e) => propFun.SetValueCWE(e, "Insurable Item", props.componentData.Iindex)}
                                                disabled={clauseData.viewdisable}
                                                    formControlProps={{
                                                        fullWidth: true
                                            ...
                                            <GridItem>
                                            <Button id="margin-left-40" color="info" onClick={()=>propFun.handledescriptionCWE("Insurable Item", props.componentData.Iindex)}>Save Description</Button>
                                            </GridItem>
                                        </div>
                                    </Modal>
                            ...
                            <Modal
                                aria-labelledby="simple-modal-title"
                                aria-describedby="simple-modal-description"
                                        open={clauseData.MasterDTO.TableList.InsurablesTable[props.componentData.Iindex].mshow}
                                        onClose={() => propFun.handleCloseCWE("Insurable Item", props.componentData.Iindex)}>
                                <div className={classes.paper} id="modal">
                                    ...
                                    <GridItem xs={3} sm={3} md={3}>           
                                                    <Button id="margin-left-180" color="info" onClick={(e) => propFun.handledataCWE(e, "Insurable Item", props.componentData.Iindex)}>Add Clause</Button>
                                    </GridItem>
                                    </GridContainer>
                               </div>
                                        </Modal>
