...
const AddCover = (props) => {
    console.log("my props index", props);
    console.log("AddCover claues", props.props.clauses);
            ...
            <CardBody>
                    <Wizard id="proWiz"
                        ...
                        steps={[
                            ...
                            { stepName: "Covers & Benefit", stepComponent:Covers, stepId: "Covers", stepData: props },
