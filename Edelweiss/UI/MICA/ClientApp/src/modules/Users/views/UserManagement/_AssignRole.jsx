                                        ...
                                        <Animated animationIn="fadeIn" animationOut="fadeOut" isVisible={true}>
                                            <CardBody>
                                                <GridContainer justify="center" display={this.state.isButtonVisibility} >
                                                    <Permission menuname={this.state.menuname} btnload1={this.state.btnload1} handleSubmit={this.handleSubmit} onChange={this.onChange} listData={this.state.listData} changeCollapse={this.changeCollapse} testCheck={this.testCheck} MasPermissionDTO={this.state.MasPermissionDTO} savepermission={this.savepermission} MasPermissionDTO={this.state.MasPermissionDTO} />
                                                </GridContainer>
                                            </CardBody>
                                        </Animated>
                                    </Card>
