            ...
            <div>
                ...
                {this.state.permissionpage ?
                    <Card>
                        ...
                        <CardBody>
                            <GridContainer justify="center" >
                                <Permission handleSubmit={this.handleSubmit} btnload1={this.state.btnload1} handleDropdown={this.handleDropdown} dashboardvalue={this.state.dashboardvalue} dasboard={this.state.dasboard} menuname={this.state.menuname} onChange={this.onChange} listData={this.state.listData} changeCollapse={this.changeCollapse} testCheck={this.testCheck} MasPermissionDTO={this.state.MasPermissionDTO} savepermission={this.savepermission} MasPermissionDTO={this.state.MasPermissionDTO} />
                            </GridContainer>
                        </CardBody>
                    </Card>
                    : null}
