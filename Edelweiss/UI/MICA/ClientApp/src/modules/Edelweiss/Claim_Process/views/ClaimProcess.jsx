...
import BankdetailsFields from "modules/Edelweiss/Claim_Process/views/BankdetailsFields.json";
                        ...
                        <Card >
                            <CardBody>
                                ...
                                <ClaimSearch TableData={this.state.TableData} handleClaimAmount={this.handleClaimAmount} ClaimDTO={this.state.ClaimDTO}
                                    ...
                                    errormessage={this.state.errormessage} ValidationUI={this.state.ValidationUI} classes={this.classes}
...
export default withStyles(loginPageStyle)(ClaimProcess);
