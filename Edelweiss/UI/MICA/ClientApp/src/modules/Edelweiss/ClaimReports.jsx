...
class ClaimReports extends React.Component {
    ...
    IsValidProductDetails = () => {
        ...
        if (this.state.ClaimDTO.claimFromDate !== "" && this.state.ClaimDTO.claimToDate !== "" && this.state.ClaimDTO.claimStatusId !== "") {
        } else {
...
export default withStyles(loginPageStyle)(ClaimReports);