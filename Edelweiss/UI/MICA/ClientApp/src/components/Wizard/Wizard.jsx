...
class Wizard extends React.Component {
        ...
        if (this.props.steps) {
            ...
            if (key > this.state.currentStep) {
                for (var i = this.state.currentStep; i < key; i++) {
                    if (this[this.props.steps[i].stepId] === undefined) {
    ...
    nextButtonClick() {
        ...
        if (this[this.props.steps[this.state.currentStep].stepId] === undefined) {
    ...
    render() {
        ...
        return (
            <div className={classes.wizardContainer} ref="wizard">
                <Card id="wizard-card" className={classes.card}>
                    <div id="tab" className={classes.wizardNavigation}>
                            ...
                            return (
                                ...
                                <div className={stepContentClasses} key={key}>
                                    <prop.stepComponent
                                        ...
                                        componentData={this.props.steps[this.state.currentStep].stepData}
                                        componentName={this.props.steps[this.state.currentStep].stepId}
                                    />
                                </div>
                            );
                        })}
                    ...
                    {/* <div className={classes.footer}>
                       ...
                       //<div className={classes.right}>
                        ...
                        //        //</Button>
                        //    ) : null}
                        //    {this.state.finishButton ? (<div></div>
                        //        //<Button
                        //        //    color="rose"
