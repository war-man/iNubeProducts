      ...
      return (
        <View>
          ...
          <View>
            ...
            <TouchableOpacity 
            onPress={() => this.props.navigation.navigate('Alert2')}
            style = {{width : 200, height: 55, borderRadius: 25, backgroundColor: '#fff', marginLeft: '28%', marginTop: '5%'}}>
