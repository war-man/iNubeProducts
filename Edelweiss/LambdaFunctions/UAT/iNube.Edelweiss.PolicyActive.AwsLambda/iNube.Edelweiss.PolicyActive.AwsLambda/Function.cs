...
namespace iNube.Edelweiss.PolicyActive.AwsLambda
{
    public class Function
    {

        /// <summary>
        /// A simple function that Calls Policy Module to Make future Policy Active
        /// UAT - ENVIRONMENT
        /// </summary>
        ...
        public async Task<dynamic> FunctionHandler(DateTime? dateTime, ILambdaContext context)
        {
            ...
            client.BaseAddress = new Uri("https://egiswitchapi.edelweisscustomeruat.com/api/Policy/PolicyActivate");
