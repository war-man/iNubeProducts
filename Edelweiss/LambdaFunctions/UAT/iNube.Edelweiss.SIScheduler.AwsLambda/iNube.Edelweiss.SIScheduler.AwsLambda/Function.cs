...
namespace iNube.Edelweiss.SIScheduler.AwsLambda
{
    public class Function
    {
        ...
        public async Task<dynamic> FunctionHandler(DateTime? dateTime, ILambdaContext context)
        {
            ...
            if (dateTime == null)
            {
                client.BaseAddress = new Uri("https://egiswitchapi.edelweisscustomeruat.com/api/Mica_EGI/MonthlySIScheduler");
            }
            else
            {
                client.BaseAddress = new Uri("https://egiswitchapi.edelweisscustomeruat.com/api/Mica_EGI/MonthlySIScheduler?dateTime=" + dateTime);
            }
