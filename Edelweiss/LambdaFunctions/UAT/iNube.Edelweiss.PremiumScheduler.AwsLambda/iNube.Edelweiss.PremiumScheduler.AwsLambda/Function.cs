...
namespace iNube.Edelweiss.PremiumScheduler.AwsLambda
{
    public class Function
    {
        ...
        public async Task<dynamic> FunctionHandler(DateTime? dateTime, ILambdaContext context)
        {
            ...
            if (dateTime == null)
            {
                client.BaseAddress = new Uri("https://egiswitchapi.edelweisscustomeruat.com/api/Mica_EGI/PremiumBooking");
            }
            else
            {
                client.BaseAddress = new Uri("https://egiswitchapi.edelweisscustomeruat.com/api/Mica_EGI/PremiumBooking?dateTime=" + dateTime);
            }
